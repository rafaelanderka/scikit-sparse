...
void CHOLMOD(spinv_block)(double *L, double *Z, double *V, Int m, Int n,
  ...
  if (m2 > 0) {
    ...
    // Z2 = - V * L2
    cblas_dsymm(CblasColMajor, // const enum CBLAS_ORDER Order,
    ...
    cblas_dgemm(CblasColMajor, // const enum CBLAS_ORDER Order
  ...
  // Z1 = L1' \ Z1
  cblas_dtrsm(CblasColMajor, // const enum CBLAS_ORDER Order
              CblasLeft,     // const enum CBLAS_SIDE Side
              CblasLower,    // const enum CBLAS_UPLO Uplo
              CblasTrans,    // const enum CBLAS_TRANSPOSE TransA
    ...
    case CHOLMOD_REAL:
      ...
      for (jl = n - 1; jl >= 0; jl--) {
        ...
        if (kmax > kmin) {
          ...
          cblas_dsymv(CblasColMajor, // const enum CBLAS_ORDER order
                      CblasLower,    // const enum CBLAS_UPLO Uplo
                      nj,            // const int N
                      1.0,           // const double alpha
                      V,             // const double *A
          ...
          Xx[perm[kmin]] = 1.0 / djj + cblas_ddot(nj,  // const int N
                                                  z,   // const double *X
                                                  1,   // const int incX
                                                  Lxj, // const double *Y
                                                  1    // const int incY
